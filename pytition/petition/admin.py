...
class PetitionAdminForm(ModelForm):
    class Meta:
        ...
        help_texts = {
            ...
            'confirmation_email_smtp_user': ugettext_lazy('Leave empty if you don\'t use any account autentication.'),
            'confirmation_email_smtp_password': ugettext_lazy('Leave empty if you don\'t use any account autentication.'),
            'confirmation_email_smtp_tls': ugettext_lazy('Connexion SMTP chiffrée via TLS, préférez ce réglage à STARTTLS. Ne pas cocher les 2. Les 2 réglages sont mutuellement exclusifs.'),
            'confirmation_email_smtp_starttls': ugettext_lazy('Connexion SMTP chiffrée via STARTTLS, préférez TLS à ce réglage. Ne pas cocher les 2. Les 2 réglages sont mutuellement exclusifs.'),
        ...
        labels = {
            ...
            'confirmation_email_smtp_user': ugettext_lazy('SMTP username'),
            'confirmation_email_smtp_password': ugettext_lazy('SMTP password'),
            'confirmation_email_smtp_tls': ugettext_lazy('SMTP via TLS?'),
            'confirmation_email_smtp_starttls': ugettext_lazy('SMTP via STARTTLS?'),
